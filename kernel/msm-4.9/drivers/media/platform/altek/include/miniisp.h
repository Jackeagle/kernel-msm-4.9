...
#define MINIISP_DRIVER_VERSION "v1.31"
...
extern  u32 mini_isp_woi_memory_read_then_write_file(u32 start_addr, u32 lineoffset,
...
extern errcode mini_isp_debug_sensor_info(void);
extern errcode mini_isp_debug_led_info(void);
