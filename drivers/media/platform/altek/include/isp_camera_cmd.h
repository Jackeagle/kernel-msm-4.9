...
}depthflowmgrpv_dgmgr_recta_quality_param;
...
}depthflowmgrpv_dgmgr_rectb_quality_param;
...
}depthflowmgrpv_invrectmgr_quality_param;
...
struct depth_rectab_invrect_param {
	depthflowmgrpv_dgmgr_recta_quality_param	depth_recta_quality;
	depthflowmgrpv_dgmgr_rectb_quality_param	depth_rectb_quality;
	depthflowmgrpv_invrectmgr_quality_param 	depth_invrect_quality;
};
...
#pragma pack(1)
struct isp_cmd_cycle_trigger_depth_process {
	u8 cycleLen;				/* effective length in cycle[], Range: 1~16 frames one cycle*/
	u16 depth_triggerBitField;	/* bit 0 : 1st frame, bit 1 : 2nd frame, ... */
	u16 depthoutput_triggerBitField;	/* bit 0 : 1st frame, bit 1 : 2nd frame, ... */
