...
extern errcode mini_isp_drv_set_max_exposure(struct isp_cmd_exposure_param *max_exposure_info);

extern errcode mini_isp_drv_set_target_mean(struct isp_cmd_target_mean *target_mean_info);

extern errcode mini_isp_drv_frame_sync_control(struct isp_cmd_frame_sync_control *frame_sync_control_param);

extern errcode mini_isp_drv_set_shot_mode(struct isp_cmd_set_shot_mode *set_shot_mode_param);

extern errcode mini_isp_drv_lighting_ctrl(struct isp_cmd_lighting_ctrl *lighting_ctrl);

extern errcode mini_isp_drv_depth_compensation(struct isp_cmd_depth_compensation_param *depth_compensation_param);

extern errcode mini_isp_drv_cycle_trigger_depth_process(struct isp_cmd_cycle_trigger_depth_process *param);

extern errcode mini_isp_drv_led_active_delay(u32 delay_ms);

extern errcode mini_isp_drv_set_min_exposure(struct isp_cmd_exposure_param *min_exposure_info);

extern errcode mini_isp_drv_set_max_exposure_slope(struct isp_cmd_max_exposure_slope *max_exposure_slope_info);
