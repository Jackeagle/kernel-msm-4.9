...
errcode mini_isp_chip_base_dump_bypass_mode_register(void)
{
	...
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "clk_gen");
	/*mipi_tx_phy_if_0*/
	misp_info("%s mipi_tx_phy_if_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_tx_phy_if_0");
	/*mipi_tx_phy_if_1*/
	misp_info("%s mipi_tx_phy_if_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_tx_phy_if_1");
	/*gen_reg*/
	misp_info("%s gen_reg", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg");
	/*mipi_slvds_rx_phy_if_0*/
	misp_info("%s mipi_slvds_rx_phy_if_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_slvds_rx_phy_if_0");
	/*mipi_slvds_rx_phy_if_1*/
	misp_info("%s mipi_slvds_rx_phy_if_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_slvds_rx_phy_if_1");
	/*ppi_bridge_a_0*/
	misp_info("%s ppi_bridge_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "ppi_bridge_a_0");
	/*ppi_bridge_a_1*/
	misp_info("%s ppi_bridge_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "ppi_bridge_a_1");
	return err;
}
...
errcode mini_isp_chip_base_dump_normal_mode_register(void)
{
	...
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_top_out_mux_a_0");
	/*tx_top_out_mux_a_1*/
	misp_info("%s tx_top_out_mux_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_top_out_mux_a_1");
	/*tx_line_merge_21_a_0*/
	misp_info("%s tx_line_merge_21_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_line_merge_21_a_0");
	/*tx_line_merge_21_b_0*/
	misp_info("%s tx_line_merge_21_b_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_line_merge_21_b_0");
	/*tx_line_merge_21_c_0*/
	misp_info("%s tx_line_merge_21_c_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_line_merge_21_c_0");
	/*tx_line_merge_21_d_0*/
	misp_info("%s tx_line_merge_21_d_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "tx_line_merge_21_d_0");
	/*mipi_csi2_tx_0*/
	misp_info("%s mipi_csi2_tx_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_csi2_tx_0");
	/*mipi_tx_phy_if_0*/
	misp_info("%s mipi_tx_phy_if_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_tx_phy_if_0");
	/*mipi_csi2_tx_1*/
	misp_info("%s mipi_csi2_tx_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_csi2_tx_1");
	/*mipi_tx_phy_if_1*/
	misp_info("%s mipi_tx_phy_if_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_tx_phy_if_1");
	/*gen_reg_depth_top*/
	misp_info("%s gen_reg_depth_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_depth_top");
	/*gen_reg_dpc_top*/
	misp_info("%s gen_reg_dpc_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_dpc_top");
	/*gen_reg_hdr_top*/
	misp_info("%s gen_reg_hdr_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_hdr_top");
	/*gen_reg_irp_top*/
	misp_info("%s gen_reg_irp_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_irp_top");
	/*gen_reg_standby_top*/
	misp_info("%s gen_reg_standby_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_standby_top");
	/*gen_reg_tx_top*/
	misp_info("%s gen_reg_tx_top", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg_tx_top");
	/*id_det_a_0*/
	misp_info("%s id_det_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "id_det_a_0");
	/*id_det_a_1*/
	misp_info("%s id_det_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "id_det_a_1");
	/*bayer_binning_a_0*/
	misp_info("%s bayer_binning_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "bayer_binning_a_0");
	/*bayer_binning_a_1*/
	misp_info("%s bayer_binning_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "bayer_binning_a_1");
	/*bayer_scl_a_0*/
	misp_info("%s bayer_scl_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "bayer_scl_a_0");
	/*bayer_scl_a_1*/
	misp_info("%s bayer_scl_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "bayer_scl_a_1");
	/*rlb_a_0*/
	misp_info("%s rlb_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "rlb_a_0");
	/*rlb_b_0*/
	misp_info("%s rlb_b_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "rlb_b_0");
	/*mipi_slvds_rx_phy_if_0*/
	misp_info("%s mipi_slvds_rx_phy_if_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_slvds_rx_phy_if_0");
	/*mipi_csi2_rx_0*/
	misp_info("%s mipi_csi2_rx_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_csi2_rx_0");
	/*mipi_slvds_rx_phy_if_1*/
	misp_info("%s mipi_slvds_rx_phy_if_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_slvds_rx_phy_if_1");
	/*mipi_csi2_rx_1*/
	misp_info("%s mipi_csi2_rx_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "mipi_csi2_rx_1");
	/*ppi_bridge_a_0*/
	misp_info("%s ppi_bridge_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "ppi_bridge_a_0");
	/*ppi_bridge_a_1*/
	...
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "hdr_ae_a_0");
	/*hdr_ae_a_1*/
	misp_info("%s hdr_ae_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "hdr_ae_a_1");
	/*gen_reg*/
	misp_info("%s gen_reg", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "gen_reg");
	return err;
...
errcode mini_isp_chip_base_dump_irp_and_depth_based_register(void)
{
	...
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "dg_ca_a_0");
	/*dg_mcc_a_0*/
	misp_info("%s dg_mcc_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "dg_mcc_a_0");
	/*dp_top_a_0*/
	misp_info("%s dp_top_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "dp_top_a_0");
	/*lvhwirp_top_a_0*/
	misp_info("%s lvhwirp_top_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvhwirp_top_a_0");
	/*lvhwirp_top_b_0*/
	misp_info("%s lvhwirp_top_b_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvhwirp_top_b_0");
	/*lvlumanr_a_0*/
	misp_info("%s lvlumanr_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvlumanr_a_0");
	/*lvlumanr_a_1*/
	misp_info("%s lvlumanr_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvlumanr_a_1");
	/*lvsharp_a_0*/
	misp_info("%s lvsharp_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvsharp_a_0");
	/*lvsharp_a_1*/
	misp_info("%s lvsharp_a_1", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "lvsharp_a_1");
	/*rectify_a_0*/
	misp_info("%s rectify_a_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "rectify_a_0");
	/*rectify_b_0*/
	misp_info("%s rectify_b_0", __func__);
	mini_isp_chip_base_define_module_reg_dump(MINIISP_INFO_DUMPLOCATION, "rectify_b_0");
	return err;
}
